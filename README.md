...
- Запускайте нужные сценарии как обычные CLI-команды (см. примеры выше). Для GUI-заготовки установите зависимости `pip install -e .[gui]` и используйте точку входа `python -m cryptocontainer_lab.gui`.
